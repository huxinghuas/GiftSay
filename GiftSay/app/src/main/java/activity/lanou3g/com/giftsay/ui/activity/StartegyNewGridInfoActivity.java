 ...
 * 攻略页面->
 */
public class StartegyNewGridInfoActivity extends AbsBaseActivity {
    ...
    protected void initDatas() {
        ...
        VolleyeInstance.getInstance().startRequest(url, new VolleyResult() {
            ...
            public void success(String resultStr) {
                ...
                titelTv.setText(bean.getData().getItems().get(2).getColumn().getCategory());
                adapter = new StarteegyClassGrideAdpter(StartegyNewGridInfoActivity.this);
