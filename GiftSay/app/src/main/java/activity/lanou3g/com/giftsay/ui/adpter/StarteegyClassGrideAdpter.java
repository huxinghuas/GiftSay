 ...
 *攻略页面 品类适配器
 */
public class StarteegyClassGrideAdpter extends BaseAdapter {
    private List<StargegyClassGrideBean.DataBean.ItemsBean> datas;

    private Context context;

    public StarteegyClassGrideAdpter(Context context) {
        this.context = context;
    }


    public void setDatas(List<StargegyClassGrideBean.DataBean.ItemsBean> datas) {
        this.datas = datas;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       StargegyClassGrideBean.DataBean.ItemsBean bean = datas.get(position);
