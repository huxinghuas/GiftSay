 ...
 * 攻略页面详情页面->
 */
public class StartegyClassGridInfoActivity extends AbsBaseActivity {
    ...
    protected void initDatas() {
        ...
        VolleyeInstance.getInstance().startRequest(url, new VolleyResult() {
            ...
            public void success(String resultStr) {
                ...
                adapter = new StarteegyClassGrideAdpter(StartegyClassGridInfoActivity.this);
                adapter.setDatas(datas);
                listView.setAdapter(adapter);
                Log.d("StartegyClassGridInfoAc", "titelTv:" + titelTv);
